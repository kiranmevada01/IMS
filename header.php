<?php
   ...
   // session_start();
    ...
    $user_query = "select * from admin where id = '$login_user'";
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="change_pass.php" class="nav-link">Change Password</a>
        </li>
         <li class="nav-item d-none d-sm-inline-block">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
       ...
       <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="image/admin/<?php echo $admin['image']; ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="add_courses.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add Courses</p>
                  </a>
                </li>
             ...
             <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="add_refrence.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add Reference</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="view_refrence.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>View Reference</p>
                  </a>
                </li>
